...
def UpdateMoney(uid,money):
    ...
    getUrl = 'http://192.168.67.15/user/getinfo?id=inputid'
    ...
    updateUrl = 'http://192.168.67.15/user/opdata?id=inputid&hallid=inputhallid&code=inputsession&dataid=15&value=inputmoney'
